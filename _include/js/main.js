...
CHAKRA.setHeight = function(){
	var $windowHeight = $(window).height();

	// Divs setting to window height
	$('#class-type').css('height',$windowHeight);
	console.log("Run Set Height")
}
...
CHAKRA.tweetFeed = function(){
    ...
    $("#ticker").tweet({
          ...
          username: "OmzaYoga", // Change this with YOUR ID
          page: 1,
          avatar_size: 0,
          count: 10,
		  template: "{text}{time}",
